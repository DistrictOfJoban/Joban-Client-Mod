...
public final class BlockEntities {
    ...
    public static final BlockEntityTypeRegistryObject<KCRStationNameSignBlockEntity> KCR_STATION_NAME_SIGN = RegistryHelper.registerBlockEntity("kcr_name_sign", KCRStationNameSignBlockEntity::new, Blocks.KCR_STATION_NAME_SIGN);
