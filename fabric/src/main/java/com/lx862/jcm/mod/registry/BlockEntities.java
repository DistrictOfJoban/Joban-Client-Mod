...
public final class BlockEntities {
    ...
    public static final BlockEntityTypeRegistryObject<SignalBlockInvertedEntityRedBelow> SIGNAL_LIGHT_INVERTED_RED_BELOW = RegistryHelper.registerBlockEntity("signal_light_inverted_2", SignalBlockInvertedEntityRedBelow::new, Blocks.SIGNAL_LIGHT_INVERTED_RED_BOTTOM);
