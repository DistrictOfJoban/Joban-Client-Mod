...
public final class BlockEntities {
    ...
    public static final BlockEntityTypeRegistryObject<LCDPIDSBlockEntity> LCD_PIDS = Registry.registerBlockEntity("pids_4", LCDPIDSBlockEntity::new, Blocks.LCD_PIDS);

    public static final BlockEntityTypeRegistryObject<RVPIDSBlockEntity> RV_PIDS = Registry.registerBlockEntity("pids_5", RVPIDSBlockEntity::new, Blocks.RV_PIDS);
