...
public final class BlockEntities {
    ...
    public static final BlockEntityTypeRegistryObject<URLEmergencyStopButtonWallBlockEntity> URL_EMG_STOP_BUTTON_WALL = JCMRegistry.registerBlockEntity("url_emg_stop_button_wall", URLEmergencyStopButtonWallBlockEntity::new, Blocks.URL_EMG_STOP_BUTTON_WALL);
