...
public final class Blocks {
    ...
    public static final BlockRegistryObject FARE_SAVER = JCMRegistry.registerBlockItem("faresaver", () -> new Block(new FareSaverBlock(org.mtr.mod.Blocks.createDefaultBlockSettings(false, state -> 15).strength(4.0f).nonOpaque())), ItemGroups.MAIN);
    ...
    public static final BlockRegistryObject LCD_PIDS = JCMRegistry.registerBlockItem("pids_lcd", () -> new Block(new LCDPIDSBlock(org.mtr.mod.Blocks.createDefaultBlockSettings(false, state -> 8).strength(2.0f).nonOpaque())), ItemGroups.PIDS);
    ...
    public static final BlockRegistryObject RV_PIDS = JCMRegistry.registerBlockItem("pids_rv", () -> new Block(new RVPIDSBlock(org.mtr.mod.Blocks.createDefaultBlockSettings(false, state -> 8).strength(2.0f).nonOpaque())), ItemGroups.PIDS);
    public static final BlockRegistryObject RV_PIDS_SIL_1 = JCMRegistry.registerBlockItem("pids_rv_sil_1", () -> new Block(new RVPIDSSIL1Block(org.mtr.mod.Blocks.createDefaultBlockSettings(false, state -> 8).strength(2.0f).nonOpaque())), ItemGroups.PIDS);
    public static final BlockRegistryObject RV_PIDS_SIL_2 = JCMRegistry.registerBlockItem("pids_rv_sil_2", () -> new Block(new RVPIDSSIL2Block(org.mtr.mod.Blocks.createDefaultBlockSettings(false, state -> 8).strength(2.0f).nonOpaque())), ItemGroups.PIDS);
    ...
    public static final BlockRegistryObject STATION_NAME_STANDING = JCMRegistry.registerBlockItem("station_name_standing", () -> new Block(new StationNameStandingBlock(org.mtr.mod.Blocks.createDefaultBlockSettings(false).strength(4.0f).nonOpaque())), ItemGroups.MAIN);
