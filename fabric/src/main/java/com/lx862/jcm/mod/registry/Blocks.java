...
public final class Blocks {
    ...
    public static final BlockRegistryObject SIGNAL_LIGHT_RED_BELOW = RegistryHelper.registerBlockItem("signal_light_red_1", new StaticSignalLightBlockRedBelow(BlockHelper.createBlockSettings(false).strength(4.0f)), ItemGroups.JCM_MAIN);
    public static final BlockRegistryObject SIGNAL_LIGHT_RED_TOP = RegistryHelper.registerBlockItem("signal_light_red_2", new StaticSignalLightBlockRedTop(BlockHelper.createBlockSettings(false).strength(4.0f)), ItemGroups.JCM_MAIN);
    public static final BlockRegistryObject SIGNAL_LIGHT_GREEN = RegistryHelper.registerBlockItem("signal_light_green", new StaticSignalLightBlockGreen(BlockHelper.createBlockSettings(false).strength(4.0f)), ItemGroups.JCM_MAIN);
    public static final BlockRegistryObject SIGNAL_LIGHT_BLUE = RegistryHelper.registerBlockItem("signal_light_blue", new StaticSignalLightBlockBlue(BlockHelper.createBlockSettings(false).strength(4.0f)), ItemGroups.JCM_MAIN);
