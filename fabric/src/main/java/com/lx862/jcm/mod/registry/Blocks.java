...
public final class Blocks {
    ...
    public static final BlockRegistryObject BUTTERFLY_LIGHT = JCMRegistry.registerBlockItem("butterfly_light", () -> new Block(new ButterflyLightBlock(BlockHelper.createBlockSettings(false).strength(3.0f).nonOpaque())), ItemGroups.MAIN);
    ...
    public static final BlockRegistryObject CEILING_SLANTED = JCMRegistry.registerBlockItem("ceiling_slanted", () -> new Block(new CeilingSlantedBlock(BlockHelper.createBlockSettings(false).strength(2.0f).nonOpaque())), ItemGroups.MAIN);
    public static final BlockRegistryObject CIRCLE_WALL_1 = JCMRegistry.registerBlockItem("circle_wall_1", () -> new Block(new CircleWallBlock(BlockHelper.createBlockSettings(false).strength(8.0f))), ItemGroups.MAIN);
    public static final BlockRegistryObject CIRCLE_WALL_2 = JCMRegistry.registerBlockItem("circle_wall_2", () -> new Block(new CircleWallBlock(BlockHelper.createBlockSettings(false).strength(8.0f))), ItemGroups.MAIN);
    public static final BlockRegistryObject CIRCLE_WALL_3 = JCMRegistry.registerBlockItem("circle_wall_3", () -> new Block(new CircleWallBlock(BlockHelper.createBlockSettings(false).strength(8.0f))), ItemGroups.MAIN);
    public static final BlockRegistryObject CIRCLE_WALL_4 = JCMRegistry.registerBlockItem("circle_wall_4", () -> new Block(new CircleWallBlock(BlockHelper.createBlockSettings(false).strength(8.0f))), ItemGroups.MAIN);
    public static final BlockRegistryObject CIRCLE_WALL_5 = JCMRegistry.registerBlockItem("circle_wall_5", () -> new Block(new CircleWallBlock(BlockHelper.createBlockSettings(false).strength(8.0f))), ItemGroups.MAIN);
    public static final BlockRegistryObject CIRCLE_WALL_6 = JCMRegistry.registerBlockItem("circle_wall_6", () -> new Block(new CircleWallBlock(BlockHelper.createBlockSettings(false).strength(8.0f))), ItemGroups.MAIN);
    public static final BlockRegistryObject CIRCLE_WALL_7 = JCMRegistry.registerBlockItem("circle_wall_7", () -> new Block(new CircleWallBlock(BlockHelper.createBlockSettings(false).strength(8.0f).nonOpaque())), ItemGroups.MAIN);
    public static final BlockRegistryObject DEPARTURE_POLE = JCMRegistry.registerBlockItem("departure_pole", () -> new Block(new DeparturePoleBlock(BlockHelper.createBlockSettings(false).strength(3.0f).nonOpaque())), ItemGroups.MAIN);
    public static final BlockRegistryObject DEPARTURE_TIMER = JCMRegistry.registerBlockItem("departure_timer", () -> new Block(new DepartureTimerBlock(BlockHelper.createBlockSettings(false, state -> 4).strength(3.0f).nonOpaque())), ItemGroups.MAIN);
    public static final BlockRegistryObject EXIT_SIGN_ODD = JCMRegistry.registerBlockItem("exit_sign_odd", () -> new Block(new ExitSignOdd(BlockHelper.createBlockSettings(false, state -> 15).strength(1.5f).nonOpaque())), ItemGroups.MAIN);
    public static final BlockRegistryObject EXIT_SIGN_EVEN = JCMRegistry.registerBlockItem("exit_sign_even", () -> new Block(new ExitSignEven(BlockHelper.createBlockSettings(false, state -> 15).strength(1.5f).nonOpaque())), ItemGroups.MAIN);
    public static final BlockRegistryObject FIRE_ALARM = JCMRegistry.registerBlockItem("fire_alarm", () -> new Block(new FireAlarmWall(BlockHelper.createBlockSettings(false).strength(1.5f).nonOpaque())), ItemGroups.MAIN);
    ...
    public static final BlockRegistryObject HELPLINE_1 = JCMRegistry.registerBlockItem("helpline_1", () -> new Block(new WallAttachedHelpLineBlock(BlockHelper.createBlockSettings(false).strength(1.5f).nonOpaque())), ItemGroups.MAIN);
    public static final BlockRegistryObject HELPLINE_2 = JCMRegistry.registerBlockItem("helpline_2", () -> new Block(new WallAttachedHelpLineBlock(BlockHelper.createBlockSettings(false).strength(1.5f).nonOpaque())), ItemGroups.MAIN);
    ...
    public static final BlockRegistryObject LCD_PIDS = JCMRegistry.registerBlockItem("pids_lcd", () -> new Block(new LCDPIDSBlock(BlockHelper.createBlockSettings(false, state -> 8).strength(2.0f).nonOpaque())), ItemGroups.PIDS);
    ...
    public static final BlockRegistryObject OPERATOR_BUTTON = JCMRegistry.registerBlockItem("operator_button", () -> new Block(new OperatorButtonBlock(BlockHelper.createBlockSettings(false, state -> 5).strength(1.0f).nonOpaque(), 40)), ItemGroups.MAIN);
    public static final BlockRegistryObject PIDS_PROJECTOR = JCMRegistry.registerBlockItem("pids_projector", () -> new Block(new PIDSProjectorBlock(BlockHelper.createBlockSettings(false).strength(2.0f).nonOpaque())), ItemGroups.PIDS);
    ...
    public static final BlockRegistryObject RV_PIDS = JCMRegistry.registerBlockItem("pids_rv", () -> new Block(new RVPIDSBlock(BlockHelper.createBlockSettings(false, state -> 8).strength(2.0f).nonOpaque())), ItemGroups.PIDS);
    public static final BlockRegistryObject RV_PIDS_SIL_1 = JCMRegistry.registerBlockItem("pids_rv_sil_1", () -> new Block(new RVPIDSSIL1Block(BlockHelper.createBlockSettings(false, state -> 8).strength(2.0f).nonOpaque())), ItemGroups.PIDS);
    public static final BlockRegistryObject RV_PIDS_SIL_2 = JCMRegistry.registerBlockItem("pids_rv_sil_2", () -> new Block(new RVPIDSSIL2Block(BlockHelper.createBlockSettings(false, state -> 8).strength(2.0f).nonOpaque())), ItemGroups.PIDS);
    public static final BlockRegistryObject RV_PIDS_POLE = JCMRegistry.registerBlockItem("rv_pids_pole", () -> new Block(new RVPIDSPole(BlockHelper.createBlockSettings(false).strength(2.0f).nonOpaque())), ItemGroups.PIDS);
    ...
    public static final BlockRegistryObject SIGNAL_LIGHT_INVERTED_RED_ABOVE = JCMRegistry.registerBlockItem("signal_light_inverted_1", () -> new Block(new InvertedSignalBlockRedAbove(BlockHelper.createBlockSettings(false).strength(1.0f))), ItemGroups.MAIN);
    public static final BlockRegistryObject SIGNAL_LIGHT_INVERTED_RED_BOTTOM = JCMRegistry.registerBlockItem("signal_light_inverted_2", () -> new Block(new InvertedSignalBlockRedBelow(BlockHelper.createBlockSettings(false).strength(1.0f))), ItemGroups.MAIN);
    public static final BlockRegistryObject STATIC_SIGNAL_LIGHT_RED_BELOW = JCMRegistry.registerBlockItem("signal_light_red_1", () -> new Block(new StaticSignalLightBlockRedBelow(BlockHelper.createBlockSettings(false).strength(1.0f))), ItemGroups.MAIN);
    public static final BlockRegistryObject STATIC_SIGNAL_LIGHT_RED_TOP = JCMRegistry.registerBlockItem("signal_light_red_2", () -> new Block(new StaticSignalLightBlockRedTop(BlockHelper.createBlockSettings(false).strength(1.0f))), ItemGroups.MAIN);
    public static final BlockRegistryObject STATIC_SIGNAL_LIGHT_GREEN = JCMRegistry.registerBlockItem("signal_light_green", () -> new Block(new StaticSignalLightBlockGreen(BlockHelper.createBlockSettings(false).strength(1.0f))), ItemGroups.MAIN);
    public static final BlockRegistryObject STATIC_SIGNAL_LIGHT_BLUE = JCMRegistry.registerBlockItem("signal_light_blue", () -> new Block(new StaticSignalLightBlockBlue(BlockHelper.createBlockSettings(false).strength(1.0f))), ItemGroups.MAIN);
    ...
    public static final BlockRegistryObject TRAIN_MODEL_E44 = JCMRegistry.registerBlockItem("train_model_e44", () -> new Block(new MTRTrainModelBlock(BlockHelper.createBlockSettings(false).strength(0.5f))), ItemGroups.MAIN);
