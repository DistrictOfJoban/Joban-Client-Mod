...
public final class Blocks {
    ...
    public static final BlockRegistryObject STATION_NAME_STANDING = Registry.registerBlockItem("station_name_standing", new StationNameStandingBlock(BlockSettings.create().strength(4.0f).nonOpaque()), ItemGroups.JCM_MAIN);
    public static final BlockRegistryObject WRL_STATION_CEILING = Registry.registerBlockItem("wrl_station_ceiling", new WRLStationCeilingBlock(BlockSettings.create().strength(4.0f).nonOpaque()), ItemGroups.JCM_CEILING);
    public static final BlockRegistryObject WRL_STATION_CEILING_POLE = Registry.registerBlockItem("wrl_station_ceiling_pole", new WRLStationCeilingPole(BlockSettings.create().strength(4.0f).nonOpaque()), ItemGroups.JCM_CEILING);
