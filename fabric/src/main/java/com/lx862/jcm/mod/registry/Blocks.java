...
public final class Blocks {
    ...
    public static final BlockRegistryObject PIDS_PROJECTOR = JCMRegistry.registerBlockItem("pids_projector", () -> new Block(new PIDSProjectorBlock(BlockHelper.createBlockSettings(false).strength(4.0f).nonOpaque())), ItemGroups.PIDS);
