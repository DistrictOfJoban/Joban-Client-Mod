...
public final class Blocks {
    ...
    public static final BlockRegistryObject STATION_CEILING_WRL = Registry.registerBlockItem("station_ceiling_wrl", new StationCeilingWRL2Block(BlockHelper.createBlockSettings(false).strength(4.0f).nonOpaque()), ItemGroups.JCM_CEILING);
    public static final BlockRegistryObject STATION_CEILING_WRL_SINGLE = Registry.registerBlockItem("station_ceiling_wrl_single", new StationCeilingWRLBlock(BlockHelper.createBlockSettings(false).strength(4.0f).nonOpaque()), ItemGroups.JCM_CEILING);
    public static final BlockRegistryObject STATION_CEILING_WRL_POLE = Registry.registerBlockItem("station_ceiling_wrl_pole", new StationCeilingWRL2Pole(BlockHelper.createBlockSettings(false).strength(4.0f).nonOpaque()), ItemGroups.JCM_CEILING);
    public static final BlockRegistryObject STATION_CEILING_WRL_POLE_SINGLE = Registry.registerBlockItem("station_ceiling_wrl_single_pole", new StationCeilingWRLPole(BlockHelper.createBlockSettings(false).strength(4.0f).nonOpaque()), ItemGroups.JCM_CEILING);
