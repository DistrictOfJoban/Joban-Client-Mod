...
public final class Blocks {
    ...
    public static final BlockRegistryObject AUTO_IRON_DOOR = RegistryHelper.registerBlockItem("auto_iron_door", () -> new Block(new AutoIronDoorBlock((blockSettings) -> blockSettings.strength(4.0f).nonOpaque())), ItemGroups.JCM_MAIN);
