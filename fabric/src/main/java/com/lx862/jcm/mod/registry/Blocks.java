...
public final class Blocks {
    ...
    public static final BlockRegistryObject FIRE_ALARM = JCMRegistry.registerBlockItem("fire_alarm", () -> new Block(new FireAlarmWallBlock(org.mtr.mod.Blocks.createDefaultBlockSettings(false).strength(1.5f).nonOpaque())), ItemGroups.MAIN);
    ...
    public static final BlockRegistryObject HELPLINE_STANDING_TKL = JCMRegistry.registerBlockItem("helpline_standing_tkl", () -> new Block(new HelpLineStandingTKLBlock(org.mtr.mod.Blocks.createDefaultBlockSettings(false, state -> 15).strength(4.0f).nonOpaque())), ItemGroups.MAIN);
    ...
    public static final BlockRegistryObject URL_EMG_STOP_BUTTON_WALL = JCMRegistry.registerBlockItem("url_emg_stop_button_wall", () -> new Block(new URLEmergencyButtonWallBlock(org.mtr.mod.Blocks.createDefaultBlockSettings(false).strength(4.0f).nonOpaque())), ItemGroups.MAIN);
