...
public final class BlockRegistry {
    ...
    public static final BlockRegistryObject LRT_INTER_CAR_BARRIER_LEFT = Registry.registerBlockItem("lrt_inter_car_barrier_left", new Block(new LRTInterCarBarrierBlock(BlockSettings.create().strength(4.0f).nonOpaque())), ItemGroupRegistry.JCM_MAIN);
    public static final BlockRegistryObject LRT_INTER_CAR_BARRIER_MIDDLE = Registry.registerBlockItem("lrt_inter_car_barrier_middle", new Block(new LRTInterCarBarrierBlock(BlockSettings.create().strength(4.0f).nonOpaque())), ItemGroupRegistry.JCM_MAIN);
    public static final BlockRegistryObject LRT_INTER_CAR_BARRIER_RIGHT = Registry.registerBlockItem("lrt_inter_car_barrier_right", new Block(new LRTInterCarBarrierBlock(BlockSettings.create().strength(4.0f).nonOpaque())), ItemGroupRegistry.JCM_MAIN);
