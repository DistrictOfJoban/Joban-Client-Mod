...
public final class BlockRegistry {
    ...
    public static final BlockRegistryObject KCR_EMG_STOP_SIGN = Registry.registerBlockItem("kcr_emg_stop_sign", new KCREmergencyStopSign(BlockSettings.create().strength(4.0f).nonOpaque()), ItemGroupRegistry.JCM_MAIN);
